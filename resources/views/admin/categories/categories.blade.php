    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            <div class="flex justify-between">
                ...
                <!-- Add Category Button -->
                <a href="{{ route('admin.categories.create') }}" class="bg-blue-500 text-white p-2 px-4 rounded mb-6 inline-block">Add Category</a>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-2 text-right">
                                    <!-- Edit Button -->
                                    <a href="{{ route('admin.categories.edit', $category->id) }}" class="text-blue-500 hover:underline mr-4">Edit</a>
